    ...
    return (
      <div className="auth-container">
        <div className="auth-card text-center">
          ...
          <Link to={`/login${searchParams.get('redirect') ? '?redirect=' + encodeURIComponent(searchParams.get('redirect')) : ''}`} className="btn-primary mt-8 inline-flex w-full justify-center">
            Go to Login
          </Link>
        </div>
      </div>
    ...
    <div className="auth-container">
      <div className="auth-card">
        ...
        <p className="mt-6 text-center text-sm text-navy-500">
          ...
          <Link to={`/login${searchParams.get('redirect') ? '?redirect=' + encodeURIComponent(searchParams.get('redirect')) : ''}`} className="font-semibold text-navy-600 hover:underline">
            Sign in
          </Link>
        </p>
      </div>
